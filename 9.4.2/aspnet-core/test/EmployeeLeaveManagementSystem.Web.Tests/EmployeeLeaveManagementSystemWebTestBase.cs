...
{
    public abstract class EmployeeLeaveManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeeLeaveManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeeLeaveManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeeLeaveManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeeLeaveManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeeLeaveManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeeLeaveManagementSystemDbContext, Task<T>> func)
        {
            T result;
