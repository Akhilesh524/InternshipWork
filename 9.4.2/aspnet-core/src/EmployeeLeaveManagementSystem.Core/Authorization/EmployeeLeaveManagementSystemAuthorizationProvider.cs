...
namespace EmployeeLeaveManagementSystem.Authorization
{
    public class EmployeeLeaveManagementSystemAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, EmployeeLeaveManagementSystemConsts.LocalizationSourceName);
        }
    }
}
