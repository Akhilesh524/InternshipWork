...
namespace EmployeeLeaveManagementSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = EmployeeLeaveManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EmployeeLeaveManagementSystemDbContext context)
        {
            _context = context;
        }
