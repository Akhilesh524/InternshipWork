...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
  ...
  getMenuItems(): MenuItem[] {
    return [
      ...
      new MenuItem(this.l('Employees'), '/app/employees', 'fas fa-user-tie', 'Employee.View'),
      new MenuItem(this.l('Founder'), '/app/founder', 'fas fa-user-tie', 'LeaveType.View'),
      new MenuItem(this.l('Manager'), '/app/manager', 'fas fa-user-tie','LeaveRequest.View.All')
    ];
  }
